...
public class HashGraph {
	// the hash function used for the HubLabel.graph
...
//	
//	// cache HubLabel.graph hash until something updated
//	private HashCode graphHash = null;
//	
//	// cache ground HubLabel.graph hash until something updated
//	private HashCode groundGraphHash = null;
	...
	/**
	 * Adds a triple to the HubLabel.graph.
...
//	
	/**
	 * Produces a cheap copy of the HubLabel.graph, where immutable objects
	 * (HubLabel.graph structure, static hashes, hash function) are copied by pointer,
...
//		clearCachedObjects();
	 ...
	 * HubLabel.graph represents all triples for each set of connected blank nodes
...
//	 * 
//	 * Two HashGraphs are considered equals if the HubLabel.graph hashes are equal, the
