...
public class AnalyseNQuadsResults {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("Largest HubLabel.graph\t"+maxTriplesDoc+" triples:\t"+maxTriples+" bnodes:\t"+maxTriplesBnodes);
		...
		System.out.println("Most leaned HubLabel.graph (per triples)\t"+maxLeanedTriplesDoc+" input triples:\t"+maxLeanedTriplesIn+" output triples:\t"+maxLeanedTriplesOut+" input bnodes:\t"+maxLeanedTriplesBnodesIn+" output bnodes:\t"+maxLeanedTriplesBnodesOut);
		System.out.println("Most leaned HubLabel.graph (per bnodes)\t"+maxLeanedBnodesDoc+" input triples:\t"+maxLeanedBnodesTriplesIn+" output triples:\t"+maxLeanedBnodesTriplesOut+" input bnodes:\t"+maxLeanedBnodesIn+" output bnodes:\t"+maxLeanedBnodesOut);
